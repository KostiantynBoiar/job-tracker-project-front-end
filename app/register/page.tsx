      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleRegister} style={styles.form}>
          <div style={styles.inputGroup}>
            ...
            <input type="text" name="username" placeholder="Username" value={formData.username} onChange={handleChange} style={styles.input} required disabled={isSubmitting} />
          </div>
          <div style={styles.inputGroup}>
        ...
        <div style={styles.socialGroup}>
          <button type="button" onClick={() => handleSocialRegister('Google')} style={styles.socialButton} disabled={isSubmitting}>
          ...
          <button type="button" onClick={() => handleSocialRegister('GitHub')} style={styles.socialButton} disabled={isSubmitting}>
